  ...
  methods: {
    ...
    init() {
      ...
      const distributions = [
        ...
        (i, t) => {
          const x = i * 0.2 - 60;
          const y = Math.sin(x * 0.3 + t * 0.001) * 2;
          const z = Math.cos(x * 0.2 + t * 0.001) * 2;
          return [x * 0.1, y, z];
        },
        // 2: Radial Wave
        (i, t) => {
          const angle = (i / N) * Math.PI * 2;
          const radius = 5 + Math.sin(angle * 4 + t * 0.001) * 2;
          const x = Math.cos(angle) * radius;
          const y = Math.sin(angle * 2 + t * 0.001) * 2;
