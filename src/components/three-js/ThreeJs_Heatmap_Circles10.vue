...
function updateSpheres(t) {
  spheres.forEach(sphere => {
    ...
    const verticalAmplitude = 0.5; // Amplitude of vertical wave
    ...
    // Reset horizontal position if it moves too far
    if (sphere.position.x > initialX + 10) {
      sphere.position.x = initialX - 10; // Reset horizontal position
    }
  });
}
// function updateSpheres(t) {
