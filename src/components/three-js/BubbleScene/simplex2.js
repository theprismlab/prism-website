/**
 * 2D simplex noise — ES module version.
 *
 * Based on Stefan Gustavson's public-domain implementation,
 * optimised by Peter Eastman, ported to JS by Joseph Gentle.
 */
...
export function simplex2(xin, yin) {
    ...
    if (t0 >= 0) { t0 *= t0; n0 = t0 * t0 * gi0.dot2(x0, y0); }

    let t1 = 0.5 - x1 * x1 - y1 * y1;
    if (t1 >= 0) { t1 *= t1; n1 = t1 * t1 * gi1.dot2(x1, y1); }

    let t2 = 0.5 - x2 * x2 - y2 * y2;
    if (t2 >= 0) { t2 *= t2; n2 = t2 * t2 * gi2.dot2(x2, y2); }
