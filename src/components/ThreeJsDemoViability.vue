      ...
      methods: {
        ...
        init(){
          ...
          for (let i = 0; i < heatmapData.length; i++) {
              ...
              const color = new THREE.Color(colorScale(d.c));
              colors.push(color.r, color.g, color.b);
          }

          const colorAttribute = new THREE.Float32BufferAttribute(colors, 3);
          heatmapPlaneGeometry.setAttribute('color', colorAttribute);
          heatmapPlaneGeometry.attributes.color.needsUpdate = true;
