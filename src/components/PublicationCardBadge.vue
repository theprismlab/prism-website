<template>
  ...
  <v-card v-if="featured" class="featured-card h-100" variant="flat" elevation="0">
  ...
  <!-- Compact list layout: small rounded icon tile inside padded card -->
