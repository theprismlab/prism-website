  ...
  <container-sm>
    <section>
      <page-title>Collaborate with us!</page-title>
        <p class="text-body-1">
          If you have a test agent you want to screen in PRISM, participate in one of our <span class="text-emphasize">PRISM Consortium Screens</span>. These screens are run four times a year, with specific dates available on the <a href="https://www.theprismlab.org/portal/submissions" target="_blank" class="text-link">PRISM Submission Hub</a>. Data for each screen is returned in approximately 4 months.
          <br><br>
...
<script>
  ...
  export default {
    data() {
      return {
       steps: [
        'Complete the forms on the <a href="https://www.theprismlab.org/portal/submissions" target="_blank" class="text-link">PRISM Submission Hub</a> during our 2-week submission window.',
