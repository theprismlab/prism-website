    ...
    <container-sm>
      <section>
        ...
        <p class="prism-text-body-1">
          ...
          <span class="text-emphasize">PRISM Consortium Screens</span>. These screens are run four
          times a year, with specific dates available on the
          <a href="https://www.theprismlab.org/portal/submissions" target="_blank" class="text-link"
            >PRISM Submission Hub</a
          >. Data for each screen is returned in approximately 4 months. <br /><br />
          <a href="/contact-us">Contact us</a> to receive updates on our screen offerings,
