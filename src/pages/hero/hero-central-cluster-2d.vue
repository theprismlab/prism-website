    ...
    <div>
        <section class="hero-section">
            <div class="hero-heatmap">
                <CentralCluster2D :scatter-config="{ clusterCount: 8, cameraAngleY: 0.3, barcodeUrl: '/images/barcode.svg' }" />
            </div>
...
<script>
import CentralCluster2D from '@/visualization/CentralCluster2D.vue';

export default {
    name: 'hero-central-cluster',
    components: {
        CentralCluster2D,
    },
}
