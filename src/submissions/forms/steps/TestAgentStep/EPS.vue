  ...
  <v-table density="compact" class="perturbation-table">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <v-text-field v-model="data.rows[0][F.DILUTION_FACTOR.key]" variant="plain" density="compact" single-line :error-messages="errors[F.DILUTION_FACTOR.key]" />
        </td>
        <td>
