...
export default class CompoundSubmissionConstants {
    ...
    static HOME_INSTITUTION = "Your institution/company name + funding institution's name (if different)";
    ...
    static BIO_TECH_ACCOUNTS_PAYABLE_EMAIL = "Email of Accounts Payable Department and Name/Email of Invoice Administrator";
    ...
    static LIST_CANCER_CELL_LINES = "List cancer cell lines that have been previously tested with your test agent";
    ...
    static MOLECULE_TYPES = ["Antibody", "Aqueous Small Molecule", "Antibody Drug Conjugate", "Small Molecule"];
    static SOLVENT = "Solvent";
    static SOLVENT_KEY = "solvent";
    static BRD_REGEX = new RegExp(CompoundSubmissionConstants.BRD_PATTERN);
    static CONCENTRATION_UNITS = CompoundSubmissionConstants.CONCENTRATION + " " + CompoundSubmissionConstants.UNITS;
    ...
    static STORAGE_CONDITIONS_OPTIONS = ["-20*c", "4*c"].concat(CompoundSubmissionConstants.STORAGE_CONDITIONS_OPTIONS_VALUES.map(word => word.toLowerCase()));
    ...
    static PI_AGREEMENT = "Is the PI on your project an institute member of the Broad Institute?";
    static PO_CO_AGREEMENT = "Will you be using a purchase order or a Broad cost object to fund your project?";
    static COM_PARTNER_AGREEMENT = "Are these test agents being submitted on behalf of a commercial partner or as part of a collaboration with a commercial partner?"

    static STORE_AGREEMENT_EPS =
        "We will store your test agents in the storage conditions that you selected in your submission template (i.e. room temperature, 4&deg;C, or -20&deg;C).";

    static STORE_AGREEMENT_AQU = CompoundSubmissionConstants.STORE_AGREEMENT_EPS;


    static STORE_AGREEMENT = CompoundSubmissionConstants.STORE_AGREEMENT_EPS;

    static CPDS_ARRIVAL = "I understand that test agents must arrive at the Broad by 12 pm EDT on the submission deadline. " +
        "Test Agents that do not arrive by the deadline will be held for approximately 4 months until the next PRISM screen. " +
        "International shipments should be sent at least 1 week before the deadline to account for shipping delays and " +
        "customs processing. ";
    static CPDS_DEADLINE = "I understand that once I have completed my submission form, PRISM will be unable to make changes to or remove these test agents in the screen.";
    static CPDS_DEADLINE_AQU =
        "Slots for this screen are limited, and submissions will be included in the order they are received. " +
        "If your submission is unable to be included in this screen, it will be prioritized for the following screen."
    static AQU_REVIEW = "We ask that you carefully review the <a target='AQU_CHW' " +
        "href='//assets.clue.io/prism/compound-submission/APS/PRISM-APS-Assay-Information.pdf'>" +
        "PRISM workflow <i class='fa fa-download' aria-hidden='true'></i></a> " +
        "to ensure your submission is compatible."
    static STOCK_AGREEMENT_AQU_1 = "In all cases, we require at least 1000uL of 250x the desired screening concentration"; // NOT USED?

    static STOCK_AGREEMENT_AQU = "In all cases, we require at least 1000uL of 250x the desired screening concentration " +
        "in an aqueous solution. All test agents will be diluted/dosed in one standard aqueous solution regardless of " +
        "submission solution, please see " +
        "<a target='AQU_CHW' href='//assets.clue.io/prism/compound-submission/APS/PRISM-APS-Assay-Information.pdf'>PRISM workflow " +
        "<i class='fa fa-download' aria-hidden='true'></i></a> for more details. " +
        "Our analysis pipeline requires all test agents be normalized to one vehicle control for data processing. " +
        "The standard aqueous solution/vehicle control mentioned above will be used for all calculations.";
   
    static STOCK_AGREEMENT_AIR = "In all cases, we require at least " + CompoundSubmissionConstants.AIR_MINIMUM_VOLUME + "µL of " + CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_MULTIPLIER + "x the desired screening concentration " + 
        "in an aqueous solution. All test agents will be diluted/dosed in one standard aqueous solution regardless of " +
        "submission solution, please see " +
        "<a target='AQU_CHW' href='//assets.clue.io/prism/compound-submission/APS/PRISM-APS-Assay-Information.pdf'>PRISM workflow " +
        "<i class='fa fa-download' aria-hidden='true'></i></a> for more details. " +
    ...
    static STOCK_AGREEMENT = "Test Agents must be provided as a stock DMSO solution. We require at least " + CompoundSubmissionConstants.MTS_MINIMUM_VOLUME + "µL of 1000x the desired screening concentration in 100% DMSO.";

    static STOCK_AGREEMENT_EPS = "Test agents must be provided as a stock DMSO solution. " +
        "The required volume should be 1000x of the desired screening concentration and is dependent on " +
        "the dilution factor you select in the submission template. 3-fold dilutions or higher require " +
        +CompoundSubmissionConstants.EPS_MINIMUM_VOLUME + "µL. " +
        "2 to 3-fold dilutions require 1500µL. 1 to 2-fold dilutions require 2000µL.";


    static STOCK_AGREEMENT_COMB = "if a test agent is included in multiple combinations, " +
        "<b><span style='text-decoration:underline;'>" + CompoundSubmissionConstants.CPS_MINIMUM_VOLUME + "µL is required per test agent per slot</span></b> and should be sent in one vial.<br/><br/>" +
        "<img src='https://assets.clue.io/clue/public/img/combination-example.png' style='width:450px;' alt='combinations restrictions'>" +
        "<br/><br/><em> For example: in drug combination of Drug A+/-Drugs B & C" +
        "- you will need to submit a <b>total of 1200µL of Drug A</b></em>";
    static OVERALLL_AGREEMENT = "I have reviewed the responses above and confirm they are correct";

    static PRISM_RIGHTS_AGREEMENT = "PRISM retains the right to use collaboratively generated data to validate and improve the PRISM platform.";
    static QC_COMPOUNDS_AGREEMENT = "The collaborator is responsible for QC'ing test agents ahead of submission. We do not have the bandwidth to do any optimization for or re-running of test agents that don't perform well in PRISM. Any test agents submitted will be run 'at-risk'.";
    static DATA_PUBLICATION_AGREEMENT = "Collaborators may use PRISM data for publication at any time. As authorship should reflect each party's contributions, we would appreciate inclusion of PRISM team members as authors.  We request 30 days notice for our team to review manuscripts and 10 days for posters.";

    static COLLABORATION_TYPE_NFP = "Broad Institute or Broad affiliate within the operating network";
    static COLLABORATION_TYPE_OTHER = "Institution/company not affiliated with Broad Institute or Dependency Map Consortium";
    static COLLABORATION_TYPE_DMC = "Dependency Map Consortium";

    static COLLABORATION_TYPE_NFP2 = "My institution is the Broad or another academic/not-for-profit institution";
    static COLLABORATION_TYPE_DMC2 = "My company is a member of the Dependency Map Consortium";

    static SCREEN_STATUSES = [
        'ACTIVE',
    ...
    static STEREO_COMMENTS = [
        'as drawn',
        'single enantiomer unknown configuration 1',
        'single enantiomer unknown configuration 2',
        'single enantiomer unknown configuration 3',
        'single enantiomer unknown configuration 4',
        'atropisomer-m',
        'atropisomer-p',
        'mixture of atropisomers',
        'single atropisomer unknown configuration 1',
        'single atropisomer unknown configuration 2'
    ];
    static CM_AMOUNT_UNITS = [
        'mg',
        'g',
        'uL',
        'mL',
     ...
     *
     */
    static findSubmissionType(screen) {
        if (screen.startsWith("APS")) {
            return CompoundSubmissionConstants.APS;
        } else if (screen.startsWith("AIR")) {
            return CompoundSubmissionConstants.AIR; // NEW AIR
        } else if (screen.startsWith("CPS")) {
            return CompoundSubmissionConstants.CPS;
        } else if (screen.startsWith("MTS")) {
            return CompoundSubmissionConstants.MTS;
        } else if (screen.startsWith("EPS")) {
            return CompoundSubmissionConstants.EPS;
        } else {
            throw "Screen : " + screen + " unknown";
        }
    }
     ...
     *
     */
    static validateSubmissionType(screen) {
        if (CompoundSubmissionConstants.submissionTypes.includes(screen)) {
            return screen;
        } else {
            throw screen + "  is not a valid submission type";
        }
    }

    static validateAgentType(submission_type, agent_type) {
        if (CompoundSubmissionConstants.SUBMISSION_TYPE_ALT_NAME[submission_type].includes(agent_type)) {
            return agent_type;
        } else {
            throw agent_type + " is not a valid agent type";
        }
    }

    static CM_CONC_UNITS = [
        'M',
        'mM',
        'uM',
        'nM'
    ...
    static requiredHeadersWithBRD = [
        CompoundSubmissionConstants.FULL_BRD
    ];

    static addAgreements(submissionType, cost_object, behalf_comm_partner) {
        const agreements = {};
        agreements[CompoundSubmissionConstants.PO_CO_AGREEMENT] = cost_object;
        agreements[CompoundSubmissionConstants.COM_PARTNER_AGREEMENT] = behalf_comm_partner;
        agreements[CompoundSubmissionConstants.PRISM_RIGHTS_AGREEMENT] = "Agree";
        agreements[CompoundSubmissionConstants.QC_COMPOUNDS_AGREEMENT] = "Agree";
        agreements[CompoundSubmissionConstants.DATA_PUBLICATION_AGREEMENT] = "Agree";


        if (submissionType === CompoundSubmissionConstants.APS) {
            agreements[CompoundSubmissionConstants.STORE_AGREEMENT_AQU] = "Agree";
            agreements[CompoundSubmissionConstants.STOCK_AGREEMENT_AQU] = "Agree";
            agreements[CompoundSubmissionConstants.CPDS_DEADLINE_AQU] = "Agree";
        } else {
            agreements[CompoundSubmissionConstants.CPDS_DEADLINE] = "Agree";
            if (submissionType === CompoundSubmissionConstants.EPS) {
                agreements[CompoundSubmissionConstants.STOCK_AGREEMENT_EPS] = "Agree";
                agreements[CompoundSubmissionConstants.STORE_AGREEMENT_EPS] = "Agree";
            } else {
                agreements[CompoundSubmissionConstants.STOCK_AGREEMENT] = "Agree";
                agreements[CompoundSubmissionConstants.STORE_AGREEMENT] = "Agree";
            }
        }
        agreements[CompoundSubmissionConstants.CPDS_ARRIVAL] = "Agree";
        agreements[CompoundSubmissionConstants.OVERALLL_AGREEMENT] = "Yes";
                ...
                if (CompoundSubmissionConstants.YesNoHeaders.includes(j)) {
                    ...
                    if (j === CompoundSubmissionConstants.TOP_DOSE_UNIT) {
                        if (!CompoundSubmissionConstants.AQUEOUS_TOP_DOSE_UNITS.includes(val.trim())) {
                            errorMessages.push(j + " must be one of '" +
                    ...
                    if (j === CompoundSubmissionConstants.STOCK_CONCENTRATION_UNITS) {
                        if (!CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS.includes(val.trim())) {
                            errorMessages.push(j + " must be one of '" +
        ...
        if ((top_dose > -1) && (stock_conc > -1) && top_dose_unit && stock_conc_unit) {
            ...
            if (top_dose_unit === CompoundSubmissionConstants.AQUEOUS_TOP_DOSE_UNITS[0]) {
                if (stock_conc_unit !== CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS[0]) {
                    errorMessages.push("Stock Concentration unit must be '" + CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS[0] + "'")
                    isError = true;
                }
            }
            if (top_dose_unit === CompoundSubmissionConstants.AQUEOUS_TOP_DOSE_UNITS[1]) {
                if (stock_conc_unit !== CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS[1]) {
                    isError = true;
                    errorMessages.push("Stock Concentration unit must be '" + CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS[1] + "'")
                }
            }
            if (!isError) {
                ...
                if (Math.abs(expected_top_dose - Number(stock_conc)) > tolerance) {
                    if (expected_top_dose !== Number(stock_conc)) {
                        errorMessages.push("250X the top dose you supplied '" +
                            top_dose +
                            " " + top_dose_unit +
                            "' must equal the stock concentration you supplied '" +
                            stock_conc + " " + stock_conc_unit + "'");
                    }
                }
            }
        }
        ...
        if ((top_dose > -1) && (stock_conc > -1) && top_dose_unit && stock_conc_unit) {
            ...
            if (top_dose_unit === CompoundSubmissionConstants.AIR_TOP_DOSE_UNIT) {
                if (stock_conc_unit !== CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_UNIT) {
                    errorMessages.push("Stock Concentration unit must be '" + CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_UNIT + "' when top dose unit is '" + CompoundSubmissionConstants.AIR_TOP_DOSE_UNIT + "'")
                    isError = true;
                }
            } else {
                // If top dose unit is not the expected AIR unit, that's an error
                errorMessages.push("Top dose unit must be '" + CompoundSubmissionConstants.AIR_TOP_DOSE_UNIT + "' for AIR submissions")
                isError = true;
            }
            ...
            if (!isError) {
                ...
                if (top_dose > max_top_dose) {
                    errorMessages.push("Top dose must be less than or equal to " + max_top_dose + " " + top_dose_unit);
                }
                ...
                const expected_top_dose = (top_dose * 0.001 * CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_MULTIPLIER); 
                const tolerance = 0.001; // Allow small floating point differences
                
                if (Math.abs(expected_top_dose - Number(stock_conc)) > tolerance) {
                    if (expected_top_dose !== Number(stock_conc)) {
                        errorMessages.push("500X the top dose you supplied '" +
                            top_dose +
                            " " + top_dose_unit +
                            "' must equal the stock concentration you supplied '" +
                            stock_conc + " " + stock_conc_unit + "'");
    ...
    static compoundDoseValidation(mapping, dat) {
        ...
        for (let j of heads) {
            ...
            if (dat.hasOwnProperty(k)) {
                ...
                if (j === CompoundSubmissionConstants.UNITS && CompoundSubmissionConstants.DEFAULT_AMOUNT_UNITS !== val) {
                    errorMessages.push("Field: " + j + " accepts only '" + CompoundSubmissionConstants.DEFAULT_AMOUNT_UNITS + "'")
                }
        ...
        if (errorMessages.length === 0) {
            if (top_dose !== stock_conc) {
                errorMessages.push("1000X the top dose you supplied '" + top_dose + " " + top_dose_unit +
                    "' must equal the stock concentration you supplied '" + stock_conc + " " + stock_conc_unit + "'");
            }
        }
        return errorMessages;
    }
    ...
    static async handleFileUploads(file, isCompoundFile, hasCombinations, submissionType) {
        ...
        if (submissionType === CompoundSubmissionConstants.APS || submissionType === CompoundSubmissionConstants.AIR) {
        ...
        try {
            if (file.name.toLowerCase().endsWith(".xlsx")) {
                ...
                if (size <= CompoundSubmissionConstants.MAX_FILE_SIZE) {
                    ...
                    payload = await CompoundSubmissionConstants.parseSubmissionFile(dataFile, expectedFileHeaders, isCompoundFile, hasCombinations, submissionType);
                ...
                if (compounds && compounds.data) {
                    ...
                    for (const dat of compounds.data) {
                        if (!isCompoundFile && hasCombinations) {
                            errorMessages = [].concat(errorMessages, CompoundSubmissionConstants.combinationDoseValidation(mapping, dat));
                        } else {
                            if (!dat.full_brd) { //if the user does not have a BRD
                                if (submissionType === CompoundSubmissionConstants.APS) {
                                    errorMessages = [].concat(errorMessages, CompoundSubmissionConstants.apsDoseValidation(mapping, dat));
                                } else if (submissionType === CompoundSubmissionConstants.AIR) {
                                    errorMessages = [].concat(errorMessages, CompoundSubmissionConstants.airDoseValidation(mapping, dat));
                                }
                                else {
                                    errorMessages = [].concat(errorMessages, CompoundSubmissionConstants.compoundDoseValidation(mapping, dat));
                                }
                            }
                        }
                    }
     ...
     */
    static async parseSubmissionFile(dataFile, expectedFileHeaders, isCompoundFile, hasCombinations, submissionType) {
        let errorMessages = [];
        let data;
        if (submissionType === CompoundSubmissionConstants.APS) {
        ...
        if (_.isEmpty(compoundData) || _.isEmpty(compoundData.data[0])) {
            ...
            if (data.headers.includes("")) {
                errorMessages.push("There is an empty column in your excel file. It is most likely the last column in the file. Please remove it and try the upload again");
            }
            const fileHeaders = data.headers.sort();
            const isSubset = expectedFileHeaders.length === _.intersection(fileHeaders.sort(), expectedFileHeaders.sort()).length;
            if (!isSubset) {
    ...
    static validateYesNoHeaders(value, mappedHeader, errorMessages) {
        if (value.trim().toUpperCase() === "YES") {
            ...
            errorMessages.push("The field '" + mappedHeader + "' requires a 'Yes' or 'No' answer, but system found '" + value.trim() + "'");
        }
    }
    ...
    static getExpectedEPSFileHeaders() {
        return _.uniq([].concat(CompoundSubmissionConstants.getExpectedCompoundFileHeaders()).concat([CompoundSubmissionConstants.DILUTION_FACTOR])).sort();
    }
    ...
    static getExpectedCompoundFileHeaders() {
        return _.uniq([].concat(CompoundSubmissionConstants.requiredHeadersWithBRD).concat(CompoundSubmissionConstants.requiredHeadersWithoutBRD).concat(CompoundSubmissionConstants.getRequiredCommonHeaders())).sort();
    }
                    ...
                    if (CompoundSubmissionConstants.getRequiredAqueousHeaders().includes(mappedHeader)) {
                        if (value && value.trim()) {
                            if (CompoundSubmissionConstants.YesNoHeaders.includes(mappedHeader)) {
                                return CompoundSubmissionConstants.validateYesNoHeaders(value, mappedHeader, errorMessages);
                            }
                            ...
                            if (mappedHeader === CompoundSubmissionConstants.TOP_DOSE_UNIT) {
                                ...
                                if (!CompoundSubmissionConstants.AQUEOUS_TOP_DOSE_UNITS.includes(top_dose_unit)) {
                                    errorMessages.push(mappedHeader + " must have units of one of the following '" +
                                        CompoundSubmissionConstants.AQUEOUS_TOP_DOSE_UNITS.join(",") + "'");
                                }
                            }
                            if (mappedHeader === CompoundSubmissionConstants.STOCK_CONCENTRATION_UNITS) {
                                const top_dose_unit = value.trim();
                                if (!CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS.includes(top_dose_unit)) {
                                    errorMessages.push(mappedHeader + " must have units of one of the following '" +
                                        CompoundSubmissionConstants.AQUEOUS_STOCK_CONCENTRATION_UNITS.join(",") + "'");
                                }
                            }
                    ...
                    if (CompoundSubmissionConstants.getRequiredAqueousHeaders().includes(mappedHeader)) {
                        if (value && value.trim()) {
                            ...
                            if (mappedHeader === CompoundSubmissionConstants.TOP_DOSE_UNIT) {
                                const top_dose_unit = value.trim();
                                if (top_dose_unit !== CompoundSubmissionConstants.AIR_TOP_DOSE_UNIT) {
                                    errorMessages.push(mappedHeader + " must be '" +
                                        CompoundSubmissionConstants.AIR_TOP_DOSE_UNIT + "' for AIR submissions");
                                }
                            }
                            ...
                            if (mappedHeader === CompoundSubmissionConstants.STOCK_CONCENTRATION_UNITS) {
                                ...
                                if (stock_conc_unit !== CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_UNIT) {
                                    errorMessages.push(mappedHeader + " must be '" +
                                        CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_UNIT + "' for AIR submissions");
                                }
                            }
    ...
    static async parseEPSCompoundTDT(file, ext = "\t") {
        ...
        const requiredCommonHeaders = [].concat(CompoundSubmissionConstants.getRequiredCommonHeaders()).concat([CompoundSubmissionConstants.DILUTION_FACTOR]);
        const errorMessages = [];
        return new Promise(function (resolve, reject) {
            Papa.parse(file, {
                delimiter: ext,
                        ...
                        if (value && value.trim()) {
                            ...
                            if (mappedHeader === CompoundSubmissionConstants.TOP_DOSE_UNIT) {
                                ...
                                if (CompoundSubmissionConstants.DEFAULT_TOP_DOSE_UNIT !== top_dose_unit) {
                                    errorMessages.push(mappedHeader + " must have units of '" + CompoundSubmissionConstants.DEFAULT_TOP_DOSE_UNIT + "'");
                                }
                            }
                            return value.trim();
                        } else {
                        ...
                        if (CompoundSubmissionConstants.NUMBER_HEADERS.includes(mappedHeader)) {
                            ...
                            if (mappedHeader === "Full BRD" && val) {
                                ...
                                if (!CompoundSubmissionConstants.BRD_REGEX.test(val.toUpperCase())) {
                                    errorMessages.push("FULL BRD column must either be blank or must be a valid 'BRD'");
                                }
                            }
                            return val;
                        }
        ...
        return new Promise(function (resolve, reject) {
            Papa.parse(file, {
                    ...
                    if (CompoundSubmissionConstants.getRequiredCombinationHeaders().includes(mappedHeader)) {
                        ...
                        if (CompoundSubmissionConstants.COMBINATION_NUMBER_HEADERS.includes(mappedHeader)) {
                            ...
                            if (val && CompoundSubmissionConstants.DEFAULT_TOP_DOSE_UNIT !== val) {
                                errorMessages.push(mappedHeader + " column must contain " + CompoundSubmissionConstants.DEFAULT_TOP_DOSE_UNIT);
                            }
                            return val;
                        } else {
                            return value?.trim();
                ...
                complete: function complete(results) {
                    ...
                    _.difference(CompoundSubmissionConstants.getExpectedCombinationFileHeaders(), headersInFile).forEach(function (header) {
                    ...
                    if (CompoundSubmissionConstants.getRequiredCommonHeaders().includes(mappedHeader)) {
                        if (value && value.trim()) {
                            ...
                            if (mappedHeader === CompoundSubmissionConstants.STORAGE_CONDITIONS) {
                                ...
                                if (CompoundSubmissionConstants.STORAGE_CONDITIONS_OPTIONS.includes(storage_conditions.toLowerCase())) {
                                    return storage_conditions;
                                } else {
                                    errorMessages.push("Please use the drop down box under Storage conditions to select a storage option. '" + storage_conditions + "' is not recognized");
                                }
                            }
                            return value.trim();
                        } else {
    ...
    static getCommonCompoundMapping() {
        const map = {};
        map[CompoundSubmissionConstants.QCED_LAST_SIX_MONTHS] = CompoundSubmissionConstants.QCED_LAST_SIX_MONTHS_KEY;
        ...
        map[CompoundSubmissionConstants.SUPPLIER_CATALOG_NAME] = CompoundSubmissionConstants.SUPPLIER_CATALOG_NAME_KEY;
        map[CompoundSubmissionConstants.STORAGE_CONDITIONS] = CompoundSubmissionConstants.STORAGE_CONDITIONS_KEY;

        map[CompoundSubmissionConstants.CONCENTRATION] = CompoundSubmissionConstants.STOCK_CONCENTRATION_KEY;
        map[CompoundSubmissionConstants.STOCK_CONCENTRATION_UNITS] = CompoundSubmissionConstants.STOCK_CONCENTRATION_UNITS_KEY;
        map[CompoundSubmissionConstants.LIST_CANCER_CELL_LINES] = CompoundSubmissionConstants.LIST_CANCER_CELL_LINES_KEY;
    ...
    static getEPSCompoundMapping() {
        ...
        map[CompoundSubmissionConstants.DILUTION_FACTOR] = CompoundSubmissionConstants.DILUTION_FACTOR_KEY;
    ...
    static validateCompoundUpload(compounds, projectInfo) {
        if (compounds && compounds.length > 0) {
            ...
            if (!numCpdsMatch) {
                return {error: "You specified " + projectInfo.total_num_cpds + " test agent(s) on the previous page, but we found " + compounds.length + " in uploaded file"};
            }
            if ((parseInt(projectInfo.total_num_cpds) === 1) && projectInfo.hasCombinations) {
                return {error: "You specified 1 test agent, but you need at least 2 test agents to run a combination"};
            }

            const errorMessages = CompoundSubmissionConstants.validationTestAgentTotalVolumes(compounds, projectInfo);
            if (errorMessages.length > 0) {
    ...
    static validationTestAgentTotalVolumes(compounds, projectInfo) {
        ...
        for (let compound of compounds) {
            ...
            if (totalVolCpd < expectedToTalVolume) {
                errorMessages.push("For Test Agent '" + compound.compound_name + "', expected total volume of at least " +
                    expectedToTalVolume + " µL, but found only " + totalVolCpd + " µL. " +
    ...
    static validationCombinationTotalVolumes(compound_data, combination_data) {
        ...
        for (let groupKey of groupKeys) {
            ...
            const expectedToTalVolume = groups[groupKey].length * CompoundSubmissionConstants.CPS_MINIMUM_VOLUME;
            if (totalVolCpd < expectedToTalVolume) {
                errorMessages.push("For Drug '" + groupKey + "', expected total volume of at least " +
                    expectedToTalVolume + " µL, but found only " + totalVolCpd + " µL. " +
        ...
        if (_.isEmpty(combination_data)) {
            ...
            if (projectInfo.total_num_cpds === 1) {
                ...
                if (JSON.stringify(soloDrugAs) !== JSON.stringify(combinationDrugAs)) {
                    ...
                    if (diffs.length > 0) {
                        errorMessages.push("The following Drug A test agents need to be run solo. '" + diffs.join(",") + "'");
                    }
                }

                for (let combination of combination_data) {
                    if (!compoundNames.includes(combination.druga)) {
                        errorMessages.push("Test agent '" + combination.druga + "' is not part of your submitted test agents");
                    }
                    if (combination.drugb && !compoundNames.includes(combination.drugb)) {
                        errorMessages.push("Test agent '" + combination.drugb + "' is not part of your submitted test agents");
                    }
            ...
            if (errorMessages.length === 0) {
                errorMessages = CompoundSubmissionConstants.validationCombinationTotalVolumes(compound_data, combination_data);
            }
            if (errorMessages.length > 0) {
                return {error: errorMessages.join("\n")}
            }
     ...
     * @returns {[]}
     */
    static sanitizeCombinationData(data) {
        return _.filter(data, function (combination) {
            return !_.isEmpty(combination) && (combination.druga || combination.drugb)
        });
    }

    static async parseExcel2TDT(url) {
        const bstr = await (await fetch(url)).arrayBuffer();
        /* data is an ArrayBuffer */
        const wb = XLSX.read(bstr, {type: 'binary'});
        /* Get first worksheet */
        ...
        const ws = wb.Sheets[wsname];
        /* Convert array of arrays */
        return XLSX.utils.sheet_to_json(ws, {blankrows: false});
    }

    static async retrieveSubmissionTemplatePlusInstructions(submission_type, agent_type) {
        const obj = {
            url: "",
            data: "",
            note: "",
        ...
        switch (submission_type.toUpperCase()) {
            case "APS":
                obj.note = "In all cases, we require at least 1000uL of 250x the desired screening concentration in an aqueous solution. " +
                    "For example, if your top screening dose is 10µM, you will submit a 2.5mM stock.";
                obj.name = "Aqueous-Test Agent-Submission Instructions : Aqueous Test Agent Submission Template";
                obj.message = "Please download and complete the aqueous submission template, leaving the column " +
                    "header names exactly as they are. A preview of the template field names and their descriptions is " +
                    "below the download link.";
                obj.template = "https://assets.clue.io/prism/compound-submission/Aqueous-Compound-SubmissionTemplate.xlsx";
                obj.url = "https://assets.clue.io/prism/compound-submission/instructions/Aqueous-Test-Agent-Submission-Instructions.xlsx";
                break;
            case "AIR":
                obj.note = "In all cases, we require at least " + CompoundSubmissionConstants.AIR_MINIMUM_VOLUME + "µL of " + CompoundSubmissionConstants.AIR_STOCK_CONCENTRATION_MULTIPLIER + "x the desired screening concentration in an aqueous solution. " +
                    "For example, if your top screening dose is 2µg/mL, you will submit a 1mg/mL stock."
                obj.name = "Aqueous-AIR-Test Agent-Submission Instructions : AIR Test Agent Submission Template";
                obj.message = "Please download and complete the aqueous submission template, leaving the column " +
                    "header names exactly as they are. A preview of the template field names and their descriptions is " +
                    "below the download link.";
                obj.template = "https://assets.clue.io/prism/compound-submission/AIR-SubmissionTemplate.xlsx";
                obj.url = "https://assets.clue.io/prism/compound-submission/instructions/AIR-Test-Agent-Submission-Instructions.xlsx"; // AIR TBD URL
                break;
            case "EPS":
                obj.note = "Test agents must be provided as a stock DMSO solution.  " +
                    "The required volume should be 1000x of the desired screening concentration and is dependent " +
                    "on the dilution factor you select in the submission template.  " +
                    "3-fold dilutions or higher require 600µL. 2 to 3-fold dilutions require 720µL.   ";
                    
                obj.name = "DMSO-EPS-Compound-Submission Instructions : EPS Test Agent Submission Instructions";
                obj.message = "Please download and complete the test agent submission template, leaving the column " +
                    "header names exactly as they are. A preview of the template field names and their descriptions is " +
                    "below the download link.";
                obj.template = "https://assets.clue.io/prism/compound-submission/DMSO-EPS-Compound-SubmissionTemplate.xlsx";
                obj.url = "https://assets.clue.io/prism/compound-submission/instructions/DMSO-EPS-Compound-Submission-Instructions.xlsx";
                break;
            case "MTS":
                obj.note = "Test agents must be provided as a stock DMSO solution.  " +
                    "We require at least 150µL of 1000X the desired screening concentration in 100% DMSO.";
                obj.name = "DMSO-Compound-Submission Instructions : Test Agent Submission Instructions";
                obj.message = "Please download and complete the test agent submission template, " +
                    "leaving the column header names exactly as they are. A preview of the template field names and their" +
                    " descriptions is below the download link.";
                obj.template = "https://assets.clue.io/prism/compound-submission/DMSO-Compound-SubmissionTemplate.xlsx";
                obj.url = "https://assets.clue.io/prism/compound-submission/instructions/DMSO-Compound-Submission-Instructions.xlsx";
                break;
            case "CPS":
                obj.note = "Test agents must be provided as a stock DMSO solution.  " +
                    "We require at least 400µL of test agent per slot of 1000X the desired screening concentration " +
                    "in 100% DMSO.";
                if (agent_type === "single-agent") {
                    ...
                    obj.name = "Combination-Compound-Submission Instructions : Compound Submission Instructions";
                    obj.message = "Please download and complete the combination submission template, leaving the column " +
                        "header names exactly as they are. A preview of the template field names and their descriptions is " +
                        "below the download link.";
                    obj.template = "https://assets.clue.io/prism/compound-submission/Combination-Submission-Template.xlsx";
                    obj.url = "https://assets.clue.io/prism/compound-submission/instructions/Combination-Compound-Submission-Instructions.xlsx";
                }
                break;
            default:
                throw "Submission Type : " + submission_type + " unknown";
        }
        obj.data = await CompoundSubmissionConstants.parseExcel2TDT(obj.url)
        obj.template_name = obj.template.split("compound-submission/")[1]
        return obj
    }

    // TO DO: instead of hardcoding conditionals, we can have a mapping of submission types to instructions and templates, and then just look it up here. This will make it easier to add new submission types in the future. Additionally, the urls for the instructions and forms are kind of inconsistent, confusing, and embedded within logic that is hard to find... 
    static async retrieveSubmissionFileUploadInstructions(submission_type, agent_type) {
        let submissionTemplatePlusInstructions;
        try {
            submissionTemplatePlusInstructions = await CompoundSubmissionConstants.retrieveSubmissionTemplatePlusInstructions(submission_type, agent_type)
        } catch (err) {
            console.log(err)
        }
        const obj = {
        ...
        obj.note = submissionTemplatePlusInstructions.note;
        if (submission_type === "APS" || submission_type === "AIR") {
            obj.url = "/portal/submissions/instructions/" + submission_type + "/aqueous";
        } else if (agent_type) {
            obj.url = "/portal/submissions/instructions/" + submission_type + "/" + agent_type;
        } else {
            obj.url = "/portal/submissions/instructions/" + submission_type;
        }
        if (submission_type === "CPS" && agent_type === "single-agent") {
            obj.img_cap = "If a test agent is included in multiple combinations, 400µL is required per test agent per slot and should be sent in one vial.<br><b>For example:</b> in drug combination of Drug A+/-Drugs B & C- you will need to submit a total of 1200µL of Drug A."
            obj.img = "https://assets.clue.io/clue/public/img/combination-example.png";
        }
        return obj
    }
    ...
    static createPayload(response) {
        ...
        if (funding) {
            ...
            if (funding.br_funding_method) {
                payload.compoundInfo.agreements[CompoundSubmissionConstants.PO_CO_AGREEMENT] = terms[funding.br_funding_method]
            }
            if (funding.br_funding_partnership) {
                payload.compoundInfo.agreements[CompoundSubmissionConstants.COM_PARTNER_AGREEMENT] = terms[funding.br_funding_partnership]
            }
            ...
            if (funding.br_funding_inst_address) {
                payload.compoundInfo.br_funding_inst = funding.br_funding_inst_name + " " + funding.br_funding_inst_address;
            }
            if (funding.grant_admin_name) {
                payload.compoundInfo.grant_admin = funding.grant_admin_name + " " + funding.grant_admin_email;
            }
        }
        return payload;
    }
