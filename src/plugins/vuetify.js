...
const prismTheme = {
  ...
  colors: {
    ...
    'primary-darken-5-desaturated': mixColors(
      darkenColor(colors[primary].darken4, 0.2),
      colors.grey.darken4,
      0.75,
    ),
    'primary-darken-6-desaturated': mixColors(
      darkenColor(colors[primary].darken4, 0.5),
      colors.grey.darken4,
      0.75,
    ),
