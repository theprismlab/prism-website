import { openBlock as n, createElementBlock as i, normalizeClass as c, renderSlot as y, normalizeStyle as L, createElementVNode as l, toDisplayString as d, resolveComponent as H, createBlock as k, resolveDynamicComponent as N, mergeProps as x, withCtx as m, Fragment as h, renderList as _, createTextVNode as v, createCommentVNode as p, createVNode as R, Transition as W, withModifiers as K } from "vue";
const t0 = {
  red: {
    base: "#f44336",
    50: "#ffebee",
...
function M(e, t, r, u, f, s) {
  return n(), i("button", {
    type: r.type,
    class: c(["prism-button", `prism-button--${r.variant}`, `prism-button--${r.size}`, { "is-disabled": r.disabled }]),
    disabled: r.disabled,
...
const w = /* @__PURE__ */ A(D, [["render", M], ["__scopeId", "data-v-8e95ccfa"]]);
...
}, Q = { class: "hero__content" }, U = { class: "hero__title" }, z = { class: "hero__description" };
function j(e, t, r, u, f, s) {
  return n(), i("section", {
    class: c(["hero__container", `hero__container--${r.variant} ${r.image ? "hero__container--image" : ""}`]),
    style: L(r.image ? {
...
const I = /* @__PURE__ */ A(J, [["render", j], ["__scopeId", "data-v-ffdf902f"]]);
...
const V = [
  ...
  { title: "Portal", route: "/portal", id: "portal", matchPrefix: !0 }
], q = {
  marketing: {
  ...
  portal: {
    ...
    resolveItem: (e, t) => {
      if (e.id === "portal")
        return { ...e, route: "/" };
      const r = (u) => ({ ...u, route: t ? `${t}${u.route}` : u.route, external: !0 });
      return e.children ? { ...e, children: e.children.map(r) } : r(e);
    }
  }
}, Y = {
  name: "PrismAppBar",
  ...
  methods: {
    _onAuthChange(e) {
      (e.key === "user_info" || e.key === null) && (this.isLoggedIn = C());
    },
    _currentPath() {
      var e;
    ...
    isParentActive(e) {
      return !e.children || !e.children.length ? !1 : e.children.some((t) => this._matchPath(t.route));
    },
    isItemActive(e) {
      ...
      if (e.matchPrefix)
        try {
          const t = new URL(e.route, window.location.href).pathname;
          return window.location.pathname.startsWith(t);
        } catch {
          return window.location.pathname.startsWith(e.route);
        }
...
}, de = ["href"], oe = ["href", "onClick"], ce = ["onClick"], pe = {
  key: 0,
  class: "prism-nav-drawer__children"
}, ue = ["href"], ge = ["href", "onClick"], he = { class: "prism-nav-drawer__actions" }, be = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
function ve(e, t, r, u, f, s) {
  const g = H("router-link");
  return n(), i("div", Z, [
    l("header", G, [
      l("div", $, [
        (n(), k(N(s.resolvedLogo.external ? "a" : "router-link"), x(s.resolvedLogo.external ? { href: s.resolvedLogo.href } : { to: s.resolvedLogo.href }, { class: "prism-app-bar__logo-link" }), {
          default: m(() => [
            l("img", {
              src: f.prismLogo,
              alt: "PRISM",
        ...
        l("button", {
          ...
          "aria-expanded": String(f.drawerOpen),
          "aria-label": "Toggle navigation",
          onClick: t[0] || (t[0] = (a) => f.drawerOpen = !f.drawerOpen)
        }, [...t[5] || (t[5] = [
          l("span", null, null, -1),
          l("span", null, null, -1),
          l("span", null, null, -1)
        ...
        l("nav", ae, [
          (n(!0), i(h, null, _(s.resolvedItems, (a, b) => (n(), i("div", {
            key: b,
            class: c(["prism-app-bar__nav-item", { "prism-app-bar__nav-item--has-children": a.children && a.children.length }])
          }, [
            a.children && a.children.length ? (n(), i("button", {
              key: 0,
              type: "button",
              class: c(["prism-app-bar__nav-link", { "is-active": s.isParentActive(a) }])
            }, [
              v(d(a.title) + " ", 1),
              t[6] || (t[6] = l("svg", {
              ...
              key: 1,
              href: a.route,
              class: c(["prism-app-bar__nav-link", { "is-active": s.isItemActive(a) }])
            }, d(a.title), 11, ne)) : (n(), k(g, {
              key: 2,
              to: a.route,
              class: c(["prism-app-bar__nav-link", { "is-active": s.isItemActive(a) }])
            }, {
            ...
            a.children && a.children.length ? (n(), i("div", re, [
              (n(!0), i(h, null, _(a.children, (o) => (n(), i(h, null, [
                o.external ? (n(), i("a", {
                  key: `ext-${o.id}`,
                  href: o.route,
                  class: c(["prism-app-bar__dropdown-link", { "is-active": e.$route && e.$route.path === o.route }])
                }, d(o.title), 11, ie)) : (n(), k(g, {
                  key: o.id,
                  to: o.route,
                  class: c(["prism-app-bar__dropdown-link", { "is-active": e.$route && e.$route.path === o.route }])
                }, {
          ...
          l("div", le, [
            (n(), k(N(s.resolvedLoginItem.external ? "a" : "router-link"), x(s.resolvedLoginItem.external ? { href: s.resolvedLoginItem.route } : { to: s.resolvedLoginItem.route }, { class: "prism-app-bar__login-btn" }), {
              default: m(() => [
                f.isLoggedIn ? (n(), i("svg", se, [...t[7] || (t[7] = [
    ...
    f.drawerOpen ? (n(), i("div", {
      key: 0,
      class: "prism-nav-drawer__backdrop",
      "aria-hidden": "true",
      onClick: t[1] || (t[1] = (a) => f.drawerOpen = !1)
    })) : p("", !0),
    R(W, { name: "prism-drawer-slide" }, {
      default: m(() => [
        f.drawerOpen ? (n(), i("nav", fe, [
          (n(!0), i(h, null, _(s.resolvedItems, (a, b) => (n(), i("div", {
            key: b,
            class: "prism-nav-drawer__item"
          }, [
            !a.children || a.children.length === 0 ? (n(), i(h, { key: 0 }, [
              a.external ? (n(), i("a", {
                key: `ext-${a.id}`,
                href: a.route,
                class: c(["prism-nav-drawer__link", { "is-active": e.$route && e.$route.path === a.route }]),
                onClick: t[2] || (t[2] = (o) => f.drawerOpen = !1)
              }, d(a.title), 11, de)) : (n(), i("a", {
                key: a.id,
                href: a.route,
                class: c(["prism-nav-drawer__link", { "is-active": e.$route && e.$route.path === a.route }]),
                onClick: K((o) => s.navigateTo(a.route), ["prevent"])
              }, d(a.title), 11, oe))
            ], 64)) : (n(), i(h, { key: 1 }, [
              l("button", {
                class: c([
                  "prism-nav-drawer__group-btn",
                  { "is-active": s.isParentActive(a), "is-open": f.openGroups.includes(b) }
                ]),
                onClick: (o) => s.toggleGroup(b)
              }, [
                v(d(a.title) + " ", 1),
                t[8] || (t[8] = l("svg", {
              ...
              f.openGroups.includes(b) ? (n(), i("div", pe, [
                (n(!0), i(h, null, _(a.children, (o) => (n(), i(h, null, [
                  o.external ? (n(), i("a", {
                    key: `ext-${o.id}`,
                    href: o.route,
                    class: c(["prism-nav-drawer__child-link", { "is-active": e.$route && e.$route.path === o.route }]),
                    onClick: t[3] || (t[3] = (X) => f.drawerOpen = !1)
                  }, d(o.title), 11, ue)) : (n(), i("a", {
                    key: o.id,
                    href: o.route,
                    class: c(["prism-nav-drawer__child-link", { "is-active": e.$route && e.$route.path === o.route }]),
                    onClick: K((X) => s.navigateTo(o.route), ["prevent"])
                  }, d(o.title), 11, ge))
                ], 64))), 256))
              ])) : p("", !0)
            ], 64))
          ...
          l("div", he, [
            (n(), k(N(s.resolvedLoginItem.external ? "a" : "router-link"), x(s.resolvedLoginItem.external ? { href: s.resolvedLoginItem.route } : { to: s.resolvedLoginItem.route }, {
              class: "prism-app-bar__login-btn",
              onClick: t[4] || (t[4] = (a) => f.drawerOpen = !1)
            }), {
              default: m(() => [
                f.isLoggedIn ? (n(), i("svg", be, [...t[9] || (t[9] = [
                  l("path", { d: "M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z" }, null, -1)
                ])])) : p("", !0),
                v(" " + d(f.isLoggedIn ? "Account" : "Log In"), 1)
              ]),
              _: 1
            }, 16))
          ])
...
const S = /* @__PURE__ */ A(Y, [["render", ve], ["__scopeId", "data-v-380a25ae"]]);
...
const me = {
  ...
  width: "20",
  height: "20"
}, Ie = { class: "prism-alert__body" }, Se = {
  key: 0,
  class: "prism-alert__title"
}, Te = { class: "prism-alert__message" };
function Pe(e, t, r, u, f, s) {
  return f.visible ? (n(), i("div", {
    key: 0,
    class: c(["prism-alert", `prism-alert--${r.variant}`, { "prism-alert--bordered": r.bordered }]),
    role: "alert"
  }, [
    l("span", Ae, [
      r.variant === "success" ? (n(), i("svg", ke, [...t[1] || (t[1] = [
        l("path", {
          "fill-rule": "evenodd",
          d: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z",
          "clip-rule": "evenodd"
        }, null, -1)
      ])])) : r.variant === "warning" ? (n(), i("svg", _e, [...t[2] || (t[2] = [
        l("path", {
          "fill-rule": "evenodd",
          d: "M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z",
          "clip-rule": "evenodd"
        }, null, -1)
      ])])) : r.variant === "error" ? (n(), i("svg", ye, [...t[3] || (t[3] = [
        l("path", {
          "fill-rule": "evenodd",
    ...
    l("div", Ie, [
      r.title ? (n(), i("p", Se, d(r.title), 1)) : p("", !0),
      l("div", Te, [
        y(e.$slots, "default", {}, () => [
          v(d(r.message), 1)
        ], !0)
...
}, Be = { class: "prism-split__image-col" }, Ne = ["src", "alt"], xe = { class: "prism-split__content-col" }, Ke = {
  key: 0,
...
function Xe(e, t, r, u, f, s) {
  return n(), i("section", {
    class: c(["prism-split", { "prism-split--reverse": r.reverse }])
  }, [
    l("div", Be, [
      r.image ? (n(), i("img", {
        key: 0,
    ...
    l("div", xe, [
      r.eyebrow ? (n(), i("p", Ke, d(r.eyebrow), 1)) : p("", !0),
      r.title ? (n(), i("h2", Ce, d(r.title), 1)) : p("", !0),
      r.body || e.$slots.default ? (n(), i("div", Le, [
        y(e.$slots, "default", {}, () => [
          v(d(r.body), 1)
        ], !0)
      ])) : p("", !0),
      e.$slots.actions ? (n(), i("div", He, [
...
}, We = { class: "prism-timeline__marker" }, De = {
  key: 0,
...
function Ue(e, t, r, u, f, s) {
  return n(), i("ol", {
    class: c(["prism-timeline", `prism-timeline--${r.variant}`])
  }, [
    (n(!0), i(h, null, _(r.steps, (g, a) => (n(), i("li", {
      key: a,
      class: c(["prism-timeline__step", { "prism-timeline__step--active": a === r.activeStep, "prism-timeline__step--completed": a < r.activeStep }])
    }, [
      t[1] || (t[1] = l("div", {
      ...
      l("div", We, [
        a < r.activeStep ? (n(), i("span", De, [...t[0] || (t[0] = [
          l("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 20 20",
            fill: "currentColor",
      ...
      l("div", Me, [
        l("p", Je, d(g.title), 1),
        g.caption ? (n(), i("p", Qe, d(g.caption), 1)) : p("", !0)
      ])
    ], 2))), 128))
  ], 2);
}
const O = /* @__PURE__ */ A(Re, [["render", Ue], ["__scopeId", "data-v-6d8972d2"]]);
...
}, je = { class: "prism-app-nav-drawer__list" }, Ee = ["href", "title"], Ve = ["innerHTML"], qe = { class: "prism-app-nav-drawer__label" }, Ye = ["innerHTML"], Ze = { class: "prism-app-nav-drawer__label" };
function Ge(e, t, r, u, f, s) {
  const g = H("router-link");
  return n(), i("nav", {
    class: c(["prism-app-nav-drawer", { "is-expanded": f.isExpanded }]),
    style: L({ top: r.top }),
    onMouseenter: t[0] || (t[0] = (a) => f.isExpanded = !0),
    onMouseleave: t[1] || (t[1] = (a) => f.isExpanded = !1),
    "aria-label": "Side navigation"
  }, [
    l("ul", je, [
      (n(!0), i(h, null, _(r.items, (a, b) => (n(), i("li", {
        key: b,
        ...
        a.external ? (n(), i("a", {
          ...
          href: a.route,
          title: a.title,
          class: c(["prism-app-nav-drawer__link", { "is-active": s.isActive(a) }])
        }, [
          l("span", {
          ...
          l("span", qe, d(a.title), 1)
        ], 10, Ee)) : (n(), k(g, {
          key: 1,
          to: a.route,
          title: a.title,
          class: c(["prism-app-nav-drawer__link", { "is-active": e.$route && e.$route.path === a.route }])
        }, {
          default: m(() => [
            l("span", {
              class: "prism-app-nav-drawer__icon",
...
const B = /* @__PURE__ */ A(ze, [["render", Ge], ["__scopeId", "data-v-b4c93d9a"]]);
B.install = function(t) {
  t.component(B.name, B);
};
const $e = [w, I, S, T, P, O, B], a0 = {
  install(e) {
