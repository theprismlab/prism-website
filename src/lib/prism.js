import { openBlock as a, createElementBlock as s, normalizeClass as u, renderSlot as y, normalizeStyle as W, createElementVNode as l, toDisplayString as o, resolveComponent as D, createBlock as k, resolveDynamicComponent as K, mergeProps as M, withCtx as g, Fragment as v, renderList as A, createTextVNode as _, createCommentVNode as p, createVNode as R, Transition as X, withModifiers as E } from "vue";
const w = {
  red: {
    base: "#f44336",
    50: "#ffebee",
...
function z() {
  if (typeof document > "u" || document.getElementById("prism-color-tokens"))
    return;
  const e = [];
  for (const [r, f] of Object.entries(w)) {
    if (r === "shades") {
    ...
    for (const [i, h] of Object.entries(f)) {
      const n = j[i];
      n && e.push(`--prism-color-${c}-${n}: ${h}`);
    }
  }
  const t = document.createElement("style");
  t.id = "prism-color-tokens", t.textContent = `:root {
  ${e.join(`;
  `)}
...
const Ft = {
  ...
  colors: {
    ...
    primary: "#277ffd",
    secondary: w.orange.base,
    accent: w.lime.base,
    error: w.red.base,
    warning: w.amber.darken2,
    success: w.green.base,
    info: "#277ffd",
    // Full Material Design palette
    ...Q(w)
  }
};
const m = (e, t) => {
...
function q(e, t, r, f, c, i) {
  return a(), s("button", {
    type: r.type,
    class: u(["prism-button", `prism-button--${r.variant}`, `prism-button--${r.size}`, { "is-disabled": r.disabled }]),
    disabled: r.disabled,
    onClick: t[0] || (t[0] = (...h) => i.onClick && i.onClick(...h))
  }, [
    y(e.$slots, "default", {}, void 0, !0)
  ], 10, V);
}
const T = /* @__PURE__ */ m(G, [["render", q], ["__scopeId", "data-v-bf515133"]]);
...
}, Z = { class: "hero__content" }, $ = { class: "hero__title" }, ee = { class: "hero__description" };
function te(e, t, r, f, c, i) {
  return a(), s("section", {
...
const I = /* @__PURE__ */ m(Y, [["render", te], ["__scopeId", "data-v-e0d066b3"]]);
...
const ae = { marketing: "", portal: "/portal" }, re = [
...
function S(e, t, r) {
  if (e.children)
    return {
      ...e,
      children: e.children.map((f) => S(f, t, r))
    };
  if (!e.route)
    return e;
  if (!e.site || e.site === t) {
    const f = ae[t] || "", c = f && e.route.startsWith(f), i = c ? e.route.slice(f.length) || "/" : e.route;
    return {
      ...e,
      route: i,
      external: !1,
...
const le = {
  ...
  computed: {
    resolvedLogo() {
      return S(se, this.site, this.baseUrl);
    },
    resolvedItems() {
      return re.map((e) => S(e, this.site, this.baseUrl));
    },
    resolvedLoginItem() {
      return S(ie, this.site, this.baseUrl);
    }
  },
  methods: {
    _onAuthChange(e) {
    ...
    isItemActive(e) {
      ...
      if (e.matchPrefix) {
        ...
        try {
          const r = new URL(t, window.location.href).pathname, f = window.location.pathname.startsWith(r);
          return f && e.excludeRoutes ? !e.excludeRoutes.includes(window.location.pathname) : f;
        } catch {
...
}, ce = { class: "prism-app-bar-root" }, de = { class: "prism-app-bar" }, oe = { class: "prism-app-bar__inner" }, fe = ["src"], ue = ["aria-expanded"], pe = {
  class: "prism-app-bar__desktop-nav",
  "aria-label": "Main navigation"
}, he = ["href"], be = {
  key: 3,
  class: "prism-app-bar__dropdown"
}, ve = ["href"], ge = { class: "prism-app-bar__cta" }, me = {
  key: 0,
...
}, Ae = ["href"], ke = ["href", "onClick"], ye = ["onClick"], we = {
  key: 0,
  class: "prism-nav-drawer__children"
}, Te = ["href", "onClick"], Ie = ["href", "onClick"], Se = { class: "prism-nav-drawer__actions" }, Pe = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
function xe(e, t, r, f, c, i) {
  const h = D("router-link");
  return a(), s("div", ce, [
    l("header", de, [
      l("div", oe, [
        (a(), k(K(i.resolvedLogo.external ? "a" : "router-link"), M(i.resolvedLogo.external ? { href: i.resolvedLogo.route } : { to: i.resolvedLogo.route }, { class: "prism-app-bar__logo-link" }), {
          default: g(() => [
            l("img", {
              src: c.prismLogo,
              alt: "PRISM",
        ...
        l("nav", pe, [
          (a(!0), s(v, null, A(i.resolvedItems, (n, b) => (a(), s("div", {
            key: b,
            class: u(["prism-app-bar__nav-item", { "prism-app-bar__nav-item--has-children": n.children && n.children.length }])
          }, [
          ...
          l("div", ge, [
            (a(), k(K(i.resolvedLoginItem.external ? "a" : "router-link"), M(i.resolvedLoginItem.external ? { href: i.resolvedLoginItem.route } : { to: i.resolvedLoginItem.route }, { class: "prism-app-bar__login-btn" }), {
              default: g(() => [
    ...
    R(X, { name: "prism-drawer-slide" }, {
      default: g(() => [
        c.drawerOpen ? (a(), s("nav", _e, [
          (a(!0), s(v, null, A(i.resolvedItems, (n, b) => (a(), s("div", {
            ...
            !n.children || n.children.length === 0 ? (a(), s(v, { key: 0 }, [
              n.external ? (a(), s("a", {
                key: `ext-${n.id}`,
                href: n.route,
                class: u(["prism-nav-drawer__link", { "is-active": e.$route && e.$route.path === n.route }]),
                onClick: t[2] || (t[2] = (d) => c.drawerOpen = !1)
              }, o(n.title), 11, Ae)) : (a(), s("a", {
                key: n.id,
                href: n.route,
                class: u(["prism-nav-drawer__link", { "is-active": e.$route && e.$route.path === n.route }]),
                onClick: E((d) => i.navigateTo(n.route), ["prevent"])
              }, o(n.title), 11, ke))
            ], 64)) : (a(), s(v, { key: 1 }, [
              l("button", {
                class: u([
              ...
              c.openGroups.includes(b) ? (a(), s("div", we, [
                (a(!0), s(v, null, A(n.children, (d) => (a(), s(v, null, [
                  d.external ? (a(), s("a", {
                    ...
                    href: d.route,
                    class: u(["prism-nav-drawer__child-link", { "is-active": i.isItemActive(d) }]),
                    onClick: E((U) => i.navigateTo(d.route, b), ["prevent"])
                  }, o(d.title), 11, Ie))
                ], 64))), 256))
              ])) : p("", !0)
            ], 64))
          ...
          l("div", Se, [
            (a(), k(K(i.resolvedLoginItem.external ? "a" : "router-link"), M(i.resolvedLoginItem.external ? { href: i.resolvedLoginItem.route } : { to: i.resolvedLoginItem.route }, {
...
const P = /* @__PURE__ */ m(le, [["render", xe], ["__scopeId", "data-v-758427f8"]]);
...
const Ce = {
  ...
  width: "20",
  height: "20"
}, Ke = { class: "prism-alert__body" }, Me = {
  key: 0,
  class: "prism-alert__title"
}, Re = { class: "prism-alert__message" };
function Xe(e, t, r, f, c, i) {
  return c.visible ? (a(), s("div", {
    ...
    l("span", Oe, [
      r.variant === "success" ? (a(), s("svg", Be, [...t[1] || (t[1] = [
        l("path", {
          "fill-rule": "evenodd",
          d: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z",
          "clip-rule": "evenodd"
        }, null, -1)
      ])])) : r.variant === "warning" ? (a(), s("svg", Ne, [...t[2] || (t[2] = [
        l("path", {
          "fill-rule": "evenodd",
          d: "M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z",
          "clip-rule": "evenodd"
        }, null, -1)
      ])])) : r.variant === "error" ? (a(), s("svg", Le, [...t[3] || (t[3] = [
        l("path", {
          "fill-rule": "evenodd",
    ...
    l("div", Ke, [
      r.title ? (a(), s("p", Me, o(r.title), 1)) : p("", !0),
      l("div", Re, [
        y(e.$slots, "default", {}, () => [
          _(o(r.message), 1)
        ], !0)
    ...
    r.dismissible ? (a(), s("button", {
      ...
      "aria-label": "Dismiss",
      onClick: t[0] || (t[0] = (...h) => i.dismiss && i.dismiss(...h))
    }, [...t[5] || (t[5] = [
      l("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 20 20",
...
const x = /* @__PURE__ */ m(Ce, [["render", Xe], ["__scopeId", "data-v-89ca1dc5"]]);
...
}, De = { class: "prism-split__image-col" }, Ee = ["src", "alt"], Fe = { class: "prism-split__content-col" }, Je = {
  key: 0,
...
function ze(e, t, r, f, c, i) {
  return a(), s("section", {
    ...
    l("div", Fe, [
      r.eyebrow ? (a(), s("p", Je, o(r.eyebrow), 1)) : p("", !0),
      r.title ? (a(), s("h2", je, o(r.title), 1)) : p("", !0),
      r.body || e.$slots.default ? (a(), s("div", Ue, [
        y(e.$slots, "default", {}, () => [
          _(o(r.body), 1)
        ], !0)
      ])) : p("", !0),
...
const C = /* @__PURE__ */ m(We, [["render", ze], ["__scopeId", "data-v-844b1b37"]]);
...
}, Ve = { class: "prism-timeline__marker" }, qe = {
  key: 0,
...
}, Ze = { class: "prism-timeline__content" }, $e = { class: "prism-timeline__title" }, et = {
  key: 0,
  class: "prism-timeline__caption"
};
function tt(e, t, r, f, c, i) {
  return a(), s("ol", {
    class: u(["prism-timeline", `prism-timeline--${r.variant}`])
  }, [
    (a(!0), s(v, null, A(r.steps, (h, n) => (a(), s("li", {
      key: n,
      ...
      l("div", Ve, [
        n < r.activeStep ? (a(), s("span", qe, [...t[0] || (t[0] = [
          l("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 20 20",
            fill: "currentColor",
      ...
      l("div", Ze, [
        l("p", $e, o(h.title), 1),
        h.caption ? (a(), s("p", et, o(h.caption), 1)) : p("", !0)
      ])
    ], 2))), 128))
  ], 2);
}
const O = /* @__PURE__ */ m(Ge, [["render", tt], ["__scopeId", "data-v-fb40f417"]]);
...
}, at = { class: "prism-app-nav-drawer__list" }, rt = ["href", "title"], st = ["innerHTML"], it = { class: "prism-app-nav-drawer__label" }, lt = ["innerHTML"], ct = { class: "prism-app-nav-drawer__label" };
function dt(e, t, r, f, c, i) {
  const h = D("router-link");
  return a(), s("nav", {
...
const B = /* @__PURE__ */ m(nt, [["render", dt], ["__scopeId", "data-v-0dfe6ab6"]]);
...
const N = /* @__PURE__ */ m(ot, [["render", ut]]);
N.install = function(t) {
  t.component(N.name, N);
};
const pt = {
  name: "PrismSectionTitle"
}, ht = { class: "prism-text-h2" };
function bt(e, t, r, f, c, i) {
  return a(), s("h2", ht, [
    y(e.$slots, "default")
  ]);
}
const L = /* @__PURE__ */ m(pt, [["render", bt]]);
L.install = function(t) {
  t.component(L.name, L);
};
const vt = {
  name: "PrismSubSectionTitle"
}, gt = { class: "prism-text-h3" };
function mt(e, t, r, f, c, i) {
  return a(), s("h3", gt, [
    y(e.$slots, "default")
  ]);
}
const H = /* @__PURE__ */ m(vt, [["render", mt]]);
  ...
  methods: {
    ...
    syncState() {
      this.items.forEach((t, r) => {
        this.hasChildren(t) && this.isParentActive(t) && (this.openGroups.includes(r) || this.openGroups.push(r));
      });
...
}, kt = ["onClick"], yt = ["innerHTML"], wt = { class: "prism-sub-nav__sidebar-label" }, Tt = {
  key: 0,
  class: "prism-sub-nav__sidebar-children"
}, It = ["href"], St = ["href"], Pt = ["innerHTML"], xt = { class: "prism-sub-nav__sidebar-label" }, Ct = ["innerHTML"], Ot = { class: "prism-sub-nav__sidebar-label" }, Bt = { class: "prism-sub-nav__bottom" }, Nt = {
  key: 0,
  class: "prism-sub-nav__panel"
}, Lt = ["href"], Ht = {
  class: "prism-sub-nav__tabs",
  "aria-label": "Section navigation"
}, Kt = ["onClick"], Mt = ["innerHTML"], Rt = { class: "prism-sub-nav__tab-label" };
function Xt(e, t, r, f, c, i) {
  const h = D("router-link");
  return a(), s("div", {
    class: "prism-sub-nav",
    style: W({ "--prism-sub-nav-top": r.top, "--prism-sub-nav-left": r.left })
  }, [
    l("nav", At, [
      (a(!0), s(v, null, A(r.items, (n, b) => (a(), s("div", {
        ...
        i.hasChildren(n) ? (a(), s(v, { key: 0 }, [
          ...
          R(X, { name: "prism-sub-nav-expand" }, {
            default: g(() => [
              c.openGroups.includes(b) ? (a(), s("div", Tt, [
                (a(!0), s(v, null, A(n.children, (d) => (a(), s(v, null, [
                  d.external ? (a(), s("a", {
                    key: `ext-${d.id || d.route}`,
                    href: d.route,
                    class: u(["prism-sub-nav__sidebar-child", { "is-active": i.isItemActive(d) }])
                  }, o(d.title), 11, It)) : (a(), k(h, {
                    key: d.id || d.route,
                    to: d.route,
                    class: u(["prism-sub-nav__sidebar-child", { "is-active": i.isItemActive(d) }])
                  }, {
    ...
    l("div", Bt, [
      R(X, { name: "prism-sub-nav-slide" }, {
        default: g(() => [
          c.mobileExpanded && i.activeMobileChildren.length ? (a(), s("div", Nt, [
      ...
      l("nav", Ht, [
        (a(!0), s(v, null, A(r.items, (n, b) => (a(), s("button", {
          ...
          l("span", Rt, o(n.title), 1)
        ], 10, Kt))), 128))
      ])
    ])
  ], 4);
}
const Wt = /* @__PURE__ */ m(_t, [["render", Xt], ["__scopeId", "data-v-bf4315a6"]]), Dt = [T, I, P, x, C, O, B, N, L, H, Wt], Jt = {
  install(e) {
    z(), Dt.forEach((t) => e.component(t.name, t));
  }
};
export {
  x as PrismAlertBanner,
  P as PrismAppBar,
  ...
  C as PrismSplitSection,
  Wt as PrismSubNav,
  H as PrismSubSectionTitle,
  O as PrismTimeline,
  w as colors,
  Jt as default,
  z as injectColorTokens,
  Ft as prismTheme
};
