...
function Y(e, t, r, f, d, i) {
  return n(), s("button", {
    ...
    disabled: r.disabled,
    onClick: t[0] || (t[0] = (...p) => i.onClick && i.onClick(...p))
  }, [
    y(e.$slots, "default", {}, void 0, !0)
  ], 10, q);
}
const I = /* @__PURE__ */ m(G, [["render", Y], ["__scopeId", "data-v-40a07fd0"]]);
...
const re = { marketing: "", portal: "/portal" }, se = [
  {
    title: "About us",
    children: [
      {
...
], ie = { route: "/", site: "marketing" }, le = { route: "/portal/log-in", site: "portal" };
function P(e, t, r) {
  if (e.children)
    return {
      ...e,
...
const de = {
  ...
  props: {
    ...
    // Set when a PrismTopBanner precedes this AppBar, so it sticks below the banner
    // instead of at the very top. Leave false to keep the AppBar fully independent.
    hasBanner: {
      type: Boolean,
      default: !1
    }
  ...
  computed: {
    ...
    resolvedItems() {
      return se.map((e) => P(e, this.site, this.baseUrl));
    },
    resolvedLoginItem() {
      return P(le, this.site, this.baseUrl);
    }
  },
  methods: {
    _onAuthChange(e) {
      (e.key === "user_info" || e.key === null) && (this.isLoggedIn = J());
    },
    _currentPath() {
      var e;
...
}, ke = ["href"], Ae = ["href", "onClick"], ye = ["onClick"], we = {
  key: 0,
...
const x = /* @__PURE__ */ m(de, [["render", xe], ["__scopeId", "data-v-261f17b0"]]);
...
const Be = {
  ...
  props: {
    variant: {
      type: String,
      default: "primary",
      validator: (e) => ["primary", "secondary", "info", "success", "warning", "error"].includes(e)
    },
    message: {
      type: String,
      default: ""
  ...
  mounted() {
    this._resizeObserver = new ResizeObserver(() => this._syncHeight()), this._resizeObserver.observe(this.$el), this._syncHeight();
  },
  beforeDestroy() {
    var e;
    (e = this._resizeObserver) == null || e.disconnect(), this._setHeightVar(0);
  },
  methods: {
    _setHeightVar(e) {
      document.documentElement.style.setProperty("--prism-top-banner-height", `${e}px`);
    },
    _syncHeight() {
      this._setHeightVar(this.visible ? this.$el.offsetHeight : 0);
    },
    dismiss() {
      this.visible = !1, this._setHeightVar(0), this.$emit("dismiss");
    }
  }
...
function He(e, t, r, f, d, i) {
  return d.visible ? (n(), s("div", {
    ...
    l("div", Oe, [
      ...
      l("button", {
        type: "button",
        class: "prism-top-banner__close",
        "aria-label": "Close banner",
        onClick: t[0] || (t[0] = (...p) => i.dismiss && i.dismiss(...p))
      }, [...t[1] || (t[1] = [
        l("svg", {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 20 20",
...
const B = /* @__PURE__ */ m(Be, [["render", He], ["__scopeId", "data-v-8abe4343"]]);
...
const O = /* @__PURE__ */ m(Ne, [["render", Fe], ["__scopeId", "data-v-89ca1dc5"]]);
...
}, ze = { class: "prism-split__image-col" }, je = ["src", "alt"], Ue = { class: "prism-split__content-col" }, Qe = {
  key: 0,
...
const C = /* @__PURE__ */ m(Je, [["render", Ye], ["__scopeId", "data-v-b4072711"]]);
...
}, $e = { class: "prism-timeline__marker" }, et = {
  key: 0,
...
const H = /* @__PURE__ */ m(Ze, [["render", st], ["__scopeId", "data-v-fb40f417"]]);
...
const it = {
  ...
  props: {
    ...
    top: {
      type: String,
      default: "var(--prism-app-bar-height)"
    }
  },
  data() {
    return {
...
const N = /* @__PURE__ */ m(it, [["render", pt], ["__scopeId", "data-v-a3319175"]]);
...
const L = /* @__PURE__ */ m(ht, [["render", vt]]);
...
const K = /* @__PURE__ */ m(gt, [["render", mt]]);
...
const M = /* @__PURE__ */ m(_t, [["render", At]]);
...
}, Tt = ["onClick"], It = ["innerHTML"], St = { class: "prism-sub-nav__sidebar-label" }, Pt = {
  key: 0,
  class: "prism-sub-nav__sidebar-children"
}, xt = ["href"], Bt = ["href"], Ot = ["innerHTML"], Ct = { class: "prism-sub-nav__sidebar-label" }, Ht = ["innerHTML"], Nt = { class: "prism-sub-nav__sidebar-label" }, Lt = { class: "prism-sub-nav__bottom" }, Kt = {
  key: 0,
...
const Ft = /* @__PURE__ */ m(yt, [["render", Et], ["__scopeId", "data-v-bf4315a6"]]), Jt = [I, S, x, B, O, C, H, N, L, K, M, Ft], Ut = {
  install(e) {
    V(), Jt.forEach((t) => e.component(t.name, t));
  }
};
export {
  O as PrismAlertBanner,
  x as PrismAppBar,
  ...
  Ft as PrismSubNav,
  M as PrismSubSectionTitle,
  H as PrismTimeline,
  B as PrismTopBanner,
  w as colors,
  Ut as default,
  V as injectColorTokens,
  jt as prismTheme
};
